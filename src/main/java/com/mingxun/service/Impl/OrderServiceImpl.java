...
import com.mingxun.converter.OrderMaster2OrderDTOConverter;
...
import com.mingxun.repository.OrderMasterRepository;
...
public class OrderServiceImpl  implements OrderService {
    ...
    public Page<OrderDTO> findList(String buyerOpenid, Pageable pageable) {
        Page<OrderMaster> orderMastersPage =
            orderMasterRepository.findByBuyerOpenid(buyerOpenid, pageable);

        List<OrderDTO> orderDTOList =
            OrderMaster2OrderDTOConverter.convert(orderMastersPage.getContent());
